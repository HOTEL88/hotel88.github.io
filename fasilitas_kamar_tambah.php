	  ...
	  <div class="container">
		...
		<section class="contact-page-section">
			<div class="people-info-wrap">
			    <form role="form" method="POST" action="fasilitas_kamar_simpan.php">
					...
					<input type="text" placeholder="Fasilitas Kamar*" class="input- subject" name="fasilitas_kamar" required>
