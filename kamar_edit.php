<?php
      include('koneksi.php'); 
        ...
        $select = mysqli_query($koneksi, "SELECT * FROM tb_kamar WHERE tipe_kamar='$tipe_kamar'") or die(mysqli_error($koneksi)); //GANTI
	  ...
	  <div class="container">
		...
		<section class="contact-page-section">
			<div class="people-info-wrap">
			    <form role="form" method="POST" action="kamar_update.php">
					...
					<input type="number" placeholder="jumlah_kamar" class="input- subject" name="jumlah_kamar"  required value="<?php echo $data['jumlah_kamar'];?>">
